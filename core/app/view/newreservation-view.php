...
<option value="">-- SELECCIONE --</option>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Técnico</label>
    <div class="col-lg-10">
...
<option value="">-- SELECCIONE --</option>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Tipo de Consulta</label>
    <div class="col-lg-10">
    <textarea class="form-control" name="sick" placeholder="Tipo Consulta"></textarea>
    </div>
  </div>
      <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Detalles</label>
    <div class="col-lg-10">
    <textarea class="form-control" name="symtoms" placeholder="Detalles"></textarea>
    </div>
  </div>
        <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Repuestos</label>
    <div class="col-lg-10">
    <textarea class="form-control" name="medicaments" placeholder="Repuestos"></textarea>
    </div>
  </div>
  <div class="form-group">
