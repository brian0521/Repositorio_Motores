...
<label class="checkbox-inline">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Tipo consulta</label>
    <div class="col-md-6">
      <textarea name="sick" class="form-control" id="sick" placeholder="Tipo de consulta"></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Repuestos</label>
    <div class="col-md-6">
      <textarea name="medicaments" class="form-control" id="sick" placeholder="Repuestos"></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Otra consulta</label>
    <div class="col-md-6">
      <textarea name="alergy" class="form-control" id="sick" placeholder="otra consulta"></textarea>
    </div>
  </div>
